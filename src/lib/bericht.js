...
- Aufbau: 1) "Die Lage": kurz, was der Spieltag gebracht hat. 2) "Das Rennen": Kommentar zur Gesamttabelle nach dieser Runde – wer führt und mit welchem Vorsprung, wer sind die Verfolger auf den Top-Plätzen, wer hat sich am meisten bewegt (Rang vorher → nachher), wer steht auf dem letzten Platz und wie weit ist es bis zum Anschluss; bei knappen Abständen das auch so benennen. 3) Ein Abschnitt je Manager (alle zehn, in Tabellenreihenfolge). 4) "Elf des Tages" (kurz). 5) "Auszeichnungen": die Auszeichnungen des Spieltags aus den Fakten (Titel, Manager, Begründung), je ein frecher Satz; gibt es keine, den Abschnitt weglassen. 6) "Ausblick" (zwei Sätze).

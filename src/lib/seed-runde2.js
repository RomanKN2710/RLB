/* Runde 2 aus dem Excel (db/seed/runde2.json) in die Datenbank übernehmen.
   Zwei Teile mit unterschiedlicher Wiederholbarkeit:
   - Geld und Kader (Käufe, Entlassungen, Vereinswechsel, Gutschriften) genau einmal,
     denn diese Zeilen haben keinen Schlüssel und würden sich sonst verdoppeln.
   - Aufstellungen, Resultate, Team der Runde und Rundenstatus bei jedem Aufruf, damit
     Korrekturen am Seed auch eine bereits eingerichtete Datenbank erreichen.
   Vom Admin gesperrte Resultatzeilen (locked) bleiben unangetastet. */

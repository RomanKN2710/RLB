...
export default async function Kader() {
  ...
  const { playerMatches, clubMatches, ensureColumns } = await import('@/lib/kicker'); await ensureColumns(); const clubSlugs = (await import('../../../db/seed/kicker-clubs.json')).default;

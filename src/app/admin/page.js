...
export default async function Admin() {
  ...
  return (<>
    <div className="adminbox"><h3>Admin · kicker-Eingang vom Handy</h3>
      ...
      <p className="mini"><a className="btn sm sec" href="/api/kicker-inbox/rlb.user.js">Tampermonkey-Skript installieren (rlb.user.js)</a> Diesen Link in einem Browser mit Tampermonkey öffnen (Firefox für Android), dann erscheint der Installationsdialog. Adresse und Schlüssel sind schon eingesetzt. Danach jede kicker-Aufstellungsseite und die Elf des Tages einfach öffnen; unten erscheint die Bestätigung.</p>
      {process.env.CRON_SECRET && <details><summary className="mini">Alternative ohne Tampermonkey: Lesezeichen-Skript für Chrome / Samsung Internet</summary><p className="mini">Text kopieren, in Chrome ein Lesezeichen anlegen und dessen Adresse durch diesen Text ersetzen (Name z. B. «rlb»). Auf jeder kicker-Aufstellungsseite dann «rlb» in die Adresszeile tippen und das Lesezeichen aus den Vorschlägen antippen.</p>
    ...
    <div className="adminbox"><h3>Admin · Datenkorrektur 20.09.2026 (Gesamt-Abgleich Blog · kicker · Excel)</h3>
      ...
      <p className="mini">Teil 2: Aufstellungen Spieltag 4 laut Blog für Pädi, Arbi, Röfe, Mark, Roman, Dani, René, David (Mike und Lazar ohne Post, bisherige Elf gilt). Arbis Elf ist unzulässig (Lemperle als M) und wird wie gepostet gespeichert; das Archiv zeigt den Fehler, die Admins entscheiden. Spieltag 3 wird abgeschlossen.</p>
